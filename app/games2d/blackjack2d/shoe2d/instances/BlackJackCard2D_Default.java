...
public class BlackJackCard2D_Default extends BlackJackCard2D{
	private Animation front,
					  back;

	public BlackJackCard2D_Default(BlackJackCard original, Animation frontAnimation, Animation backAnimation){
		super(original);
